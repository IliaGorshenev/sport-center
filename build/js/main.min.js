...
var scrollTo = function scrollTo(where) {
  var SCROLL_TARGET = document.querySelector("[data-scroll-to=\"".concat(where, "\"]"));
  var elementPosition = SCROLL_TARGET.getBoundingClientRect().top;
  window.scrollBy({
    top: elementPosition,
    behavior: 'smooth'
  });
};
var SCROLL_ITEM = document.querySelector("[data-scroll=\"price\"]");
