...
var PRICE_BUTTONS = document.querySelectorAll('[data-price-button]');
var PRICE_LISTS = document.querySelectorAll('[data-price-list]');
var PRICE_PERIOD_ITEMS = document.querySelectorAll('[data-price-period-item]');
var PRICE_PERIOD_LINKS = document.querySelectorAll('[data-price-period-link]');
var priceOpener = function priceOpener(where) {
  var PRICE_LIST = document.querySelector("[data-price-list=\"".concat(where, "\"]"));
  PRICE_LISTS.forEach(function (list) {
    list.classList.remove('price__card-list--active');
  });
  PRICE_LIST.classList.add('price__card-list--active');
};
PRICE_BUTTONS.forEach(function (priceButton) {
  priceButton.addEventListener('click', function (evt) {
    evt.preventDefault();
    priceOpener(priceButton.getAttribute('data-price-button'));
    PRICE_PERIOD_ITEMS.forEach(function (item) {
      item.classList.remove('price__period-item--active');
    });
    PRICE_PERIOD_LINKS.forEach(function (link) {
...
var DESKTOP_BREAKPOINT = window.matchMedia("(min-width: 1199px)");
var TABLET_BRAKEPOINT = window.matchMedia("(min-width: 980px)");
var MOBILE_BREAKPOINT = window.matchMedia("(min-width: 767px)");
var PLAYER = document.querySelector('[data-video-button]');
var IFRAME = document.querySelector('[data-video]');
var VIDEO_LAYER = document.querySelector('[data-video-layer]');
PLAYER.addEventListener('click', function (evt) {
  ...
  setTimeout(function () {
    return VIDEO_LAYER.remove();
  }, 300);
});
var breakpointChecker = function breakpointChecker() {
  if (DESKTOP_BREAKPOINT.matches) {
    var swiper1 = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.swiper--1', {
      loop: true,
      slidesPerView: 4,
      spaceBetween: 3.1 + '%',
    ...
    var _swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.swiper--1', {
      loop: true,
      slidesPerView: 3,
      spaceBetween: 3 + '%',
      modules: [swiper__WEBPACK_IMPORTED_MODULE_2__["Navigation"]],
    ...
    var _swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.swiper--1', {
      loop: true,
      slidesPerView: 2,
      spaceBetween: 5.6 + '%',
      modules: [swiper__WEBPACK_IMPORTED_MODULE_2__["Navigation"]],
    ...
    var _swiper3 = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.swiper--1', {
      loop: true,
      slidesPerView: 1,
      spaceBetween: 0,
      modules: [swiper__WEBPACK_IMPORTED_MODULE_2__["Navigation"]],
...
breakpointChecker();
var swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.swiper--2', {
  loop: false,
  slidesPerView: 1,
  mousewheel: {
    invert: false,
